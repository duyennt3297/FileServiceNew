import svgPaths from "./svg-6v2d781krz";
...
function Button2() {
  return (
    <div className="bg-white h-[36px] relative rounded-[8px] shrink-0 w-[54px]" data-name="Button">
      <div className="content-stretch flex gap-[8px] items-center overflow-clip px-[12px] py-[8px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#f24141] text-[14px] text-nowrap">Ẩn</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#f24141] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
export default function ThaoTacnHangLot() {
  return (
    <div className="bg-white relative size-full" data-name="Thao tác Ẩn hàng loạt">
      <Frame59 />
      <BadgeBase7 />
    </div>
  );
