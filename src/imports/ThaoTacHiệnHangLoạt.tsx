import svgPaths from "./svg-o9sfv2cyks";
...
function NavigationTemplate() {
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative shrink-0 w-full" data-name="Navigation-template">
...
function Button() {
  return (
    <div className="bg-white h-[36px] relative rounded-[8px] shrink-0" data-name="Button">
      <div className="content-stretch flex gap-[8px] h-full items-center overflow-clip px-[12px] py-[8px] relative rounded-[inherit]">
...
function Button1() {
  return (
    <div className="bg-white h-[36px] relative rounded-[8px] shrink-0" data-name="Button">
      <div className="content-stretch flex gap-[8px] h-full items-center overflow-clip px-[12px] py-[8px] relative rounded-[inherit]">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#f24141] text-[14px] text-nowrap">Hiện</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#f24141] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[36px] justify-center leading-[0] not-italic relative shrink-0 text-[#101828] text-[14px] text-center w-[110px]">
        <p className="leading-[18px]">Đã chọn: 2</p>
      </div>
...
function Frame65() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow h-[1080px] items-start min-h-px min-w-px relative shrink-0">
      <NavigationTemplate />
      <Frame64 />
    </div>
  );
...
export default function ThaoTacHinHangLot() {
  return (
    <div className="bg-white relative size-full" data-name="Thao tác hiện hàng loạt">
      <Frame63 />
    </div>
  );
}